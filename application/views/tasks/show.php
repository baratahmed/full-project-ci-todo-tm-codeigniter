...
<ul id="info">
    <li>Created On: <strong><?php echo date("n-j-Y",strtotime($task->task_create_date)); ?></strong></li>
...
<li>Due Date: <strong><?php echo date("n-j-Y",strtotime($task->due_date)); ?></strong></li>
</ul><br />
